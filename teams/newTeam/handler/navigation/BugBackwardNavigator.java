...
public class BugBackwardNavigator implements Navigator {
    ...
    public BugBackwardNavigator(RobotController rc, Knowledge know, MovementController mc,
    ...
    public Direction getMovementDirection() {
        return movementDirection.opposite();
    }
...
//            action = MovementAction.MOVE_FORWARD;
        if(myK.myDirection == dir.opposite())
