...
public class ComponentsHandler {
    ...
    private BroadcastController myBBC;
    ...
    public int isGroundTraversable(MapLocation location) {
        ...
        return mySH.isGroundTraversable(location);
    }
...
//    }
    ...
    public boolean broadcast(Message composedMessage) {
        ...
        if (composedMessage == null || myBBC == null) {
            return false;
        }
        ...
        try {
            ...
            myBBC.broadcast(composedMessage);
            return true;
        } catch (Exception e) {
            Logger.debug_printExceptionMessage(e);
            return false;
    ...
    public ComponentType[] updateComponents() {
        ...
        for ( ComponentController newComp : newComps ) {
            ...
            switch (newCompType) { // TODO: handle IRON, JUMP, DROPSHIP, BUG, DUMMY
                ...
                case DISH:
                case NETWORK:
                    myBBC = (BroadcastController) newComp;
                    hasComm = true;
                    break;
